...
export default function Discover({ initialPresets }) {
          ...
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/80 backdrop-blur-xl">
            ...
            >
              <div className="flex justify-between items-center p-6 border-b border-zinc-800/50">
                ...
                <button onClick={() => setPreviewPreset(null)} className="text-zinc-500 hover:text-white transition-colors p-2 bg-zinc-900 rounded-full hover:bg-zinc-800" aria-label="Close preview">
