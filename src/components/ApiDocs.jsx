      ...
      {config.authEndpointEnabled && (
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="border border-white/5 bg-black/20 rounded-xl overflow-hidden flex flex-col group/ep hover:border-white/10 transition-colors">
              <div className="p-3 sm:p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white/[0.01]">
                <div className="flex items-center gap-3">
                  <span className={`px-2.5 py-1 rounded-md text-xs font-bold border w-16 text-center ${getMethodColor('POST')}`}>
                    POST
                  </span>
                ...
                <span className="text-sm text-neutral-400">Authenticate and receive a JWT</span>
              </div>
              ...
              <div className="p-4 border-t border-white/5 bg-black/40 grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <pre className="text-xs font-mono text-neutral-300 bg-black/60 p-3 rounded-lg border border-green-500/10 overflow-x-auto h-full max-h-48 custom-scrollbar">
                    {JSON.stringify({ token: "eyJhbGciOiJIUzI1...", message: "Mock login successful" }, null, 2)}
                  </pre>
                </div>
              </div>
            </div>
